...
| `MetadataCache` | `app`, `computeMetadataAsync`, `fileCache`, `isSupportedFile`, `iterateRefsForFile`, `metadataCache` |
| `Modal` | `bgEl`, `headerEl` |
...
| `WorkspaceTabs` | `currentTab`, `isStacked`, `selectTab`, `selectTabIndex`, `setStacked` |
