...
const CONFORMANCE_BACKLOG = new Set<string>([
  ...
  'CapacitorAdapter: extra member "getFilePath" must end with "__"',
  'DateValue: missing member "dateOnly"',
  'DateValue: missing member "parseFromString"',
  'DateValue: missing member "relative"',
  'DurationValue: missing member "addToDate"',
  'DurationValue: missing member "fromMilliseconds"',
  'DurationValue: missing member "getMilliseconds"',
  'DurationValue: missing member "parseFromString"',
  ...
  'ListValue: missing member "concat"',
  'ListValue: missing member "get"',
  'ListValue: missing member "includes"',
  'ListValue: missing member "length"',
  ...
  'missing export "PopoverState"',
  'MomentFormatComponent: extra member "defaultFormat" must end with "__"',
  'NullValue: missing member "value"',
  'ObjectValue: missing member "get"',
  'ObjectValue: missing member "isEmpty"',
  'Plugin: extra member "commands" must end with "__"',
  'Plugin: missing member "onExternalSettingsChange"',
  'Plugin: missing member "registerBasesView"',
  'Plugin: missing member "registerCliHandler"',
  'Plugin: missing member "registerEditorExtension"',
  'Plugin: missing member "registerEditorSuggest"',
  'Plugin: missing member "registerObsidianProtocolHandler"',
  'PluginSettingTab: extra member "plugin" must end with "__"',
  'RelativeDateValue: missing member "dateOnly"',
  'RelativeDateValue: missing member "parseFromString"',
  'RelativeDateValue: missing member "relative"',
