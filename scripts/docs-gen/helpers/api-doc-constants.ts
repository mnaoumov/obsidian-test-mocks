...
/**
The obsidian-test-mocks repo root. Override with DOCS_ROOT for out-of-tree runs.
*/
export const ROOT_DIR = process.env['DOCS_ROOT'] ?? resolve(process.cwd());

export const BASE_PATH = '/obsidian-test-mocks';
...
export const TS_GLOBAL_TYPES: Record<string, string> = {
  ...
  TurndownService: 'https://github.com/mixmark-io/turndown#readme',
