 ...
 *
 * (obsidian-test-mocks mirrors `obsidian.d.ts` rather than augmenting it, and draws no
 * official-vs-unofficial distinction, so there is no merge machinery here — only the generic
 * inheritance helpers. The mock-only surface is marked by the `__` suffix in the names themselves.)
 */
